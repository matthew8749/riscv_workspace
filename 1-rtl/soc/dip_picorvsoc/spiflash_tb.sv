...
module spiflash_tb();
  ...
  initial begin
    $fsdbDumpfile("spiflash_tb.fsdb");
    $fsdbDumpvars(0, spiflash_tb, "+mda");
    $fsdbDumpMDA();
  end
  ...
  initial begin
    ...
    xfer_spi(offset[7:0]);
    xfer_spi(8'h 00); tb_expect(word0[7:0]);
    xfer_spi(8'h 00); tb_expect(word0[15:8]);
    xfer_spi(8'h 00); tb_expect(word0[23:16]);
    xfer_spi(8'h 00); tb_expect(word0[31:24]);
    xfer_spi(8'h 00); tb_expect(word1[7:0]);
    xfer_spi(8'h 00); tb_expect(word1[15:8]);
    xfer_spi(8'h 00); tb_expect(word1[23:16]);
    xfer_spi(8'h 00); tb_expect(word1[31:24]);
    xfer_end;
    ...
    xfer_qspi_wr(8'h a5);
    repeat (8) xfer_dummy;
    xfer_qspi_rd; tb_expect(word0[7:0]);
    xfer_qspi_rd; tb_expect(word0[15:8]);
    xfer_qspi_rd; tb_expect(word0[23:16]);
    xfer_qspi_rd; tb_expect(word0[31:24]);
    xfer_qspi_rd; tb_expect(word1[7:0]);
    xfer_qspi_rd; tb_expect(word1[15:8]);
    xfer_qspi_rd; tb_expect(word1[23:16]);
    xfer_qspi_rd; tb_expect(word1[31:24]);
    xfer_end;
    ...
    repeat (8) xfer_dummy;
    xfer_qspi_ddr_rd; tb_expect(word0[7:0]);
    xfer_qspi_ddr_rd; tb_expect(word0[15:8]);
    xfer_qspi_ddr_rd; tb_expect(word0[23:16]);
    xfer_qspi_ddr_rd; tb_expect(word0[31:24]);
    xfer_qspi_ddr_rd; tb_expect(word1[7:0]);
    xfer_qspi_ddr_rd; tb_expect(word1[15:8]);
    xfer_qspi_ddr_rd; tb_expect(word1[23:16]);
    xfer_qspi_ddr_rd; tb_expect(word1[31:24]);
    xfer_end;
